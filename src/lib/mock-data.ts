...
export const mockArtworks = [
  ...
  },
  {
    ...
    artist_id: 'a2',
    title: 'Преломление',
    media_type: '3d' as const,
    file_url: '/models/refraction.glb',
    thumb_url: '/artworks/refraction.png',
    price: 3500,
    license_type: 'commercial' as const,
    polygon_count: 45000,
    lod_levels: 3,
    description: 'Интерактивная 3D-скульптура, исследующая преломление цифрового света',
    position_x: 0,
    position_y: 0,
    position_z: -8,
  ...
  },
  {
    ...
    thumb_url: '/artworks/pulse.png',
    price: 2000,
    license_type: 'personal' as const,
    polygon_count: null,
    lod_levels: null,
    description: 'Видео-арт: ритм и пульсация的城市 среды',
    position_x: 3,
    position_y: 1.5,
    position_z: -5,
    artist: { bio: 'Генеративный художник', tier: 'premium', user_id: 'a2' },
  },
  {
    ...
    media_type: '3d' as const,
    file_url: '/models/growth.glb',
    thumb_url: '/artworks/growth.png',
    price: 5000,
    license_type: 'commercial' as const,
    polygon_count: 62000,
    lod_levels: 3,
    description: 'Генеративная 3D-инсталляция, моделирующая рост органических форм',
    position_x: 0,
    position_y: 0,
    position_z: -10,
    artist: { bio: 'Генеративный художник', tier: 'premium', user_id: 'a2' },
